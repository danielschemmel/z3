...
public:
    ...
    void get_full_unsat_core(vector<expr*> &core) {
    ...
    void get_levels(vector<expr*> const& vars, vector<unsigned>& depth) override { m_solver.get_levels(vars, depth); }
    ...
    void get_labels(vector<symbol> &r) override { m_solver.get_labels(r); }
